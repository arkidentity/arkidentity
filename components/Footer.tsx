        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/team" className="text-gray-300 hover:text-gold transition">
                  Team
                </Link>
              </li>
              <li>
                <Link href="/beliefs" className="text-gray-300 hover:text-gold transition">
                  What We Believe
                </Link>
              </li>
              <li>
                <Link href="/giving" className="text-gray-300 hover:text-gold transition">
                  Giving
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/vision-2026" className="text-gray-300 hover:text-gold transition">
                  Vision 2026
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              <a href="#" className="text-gray-300 hover:text-gold transition" aria-label="YouTube">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </a>
              <a href="#" className="text-gray-300 hover:text-gold transition" aria-label="Instagram">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="text-gray-300 hover:text-gold transition" aria-label="Facebook">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
